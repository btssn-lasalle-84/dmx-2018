...
/**
  *\file enttecdmxusb.h
  *
  *\brief Declaration de la classe EnttecDMXUSB
  *
  *
...
/**
 * @brief Classe permettant la communication avec l'interface Enttec
 *
 *
 * \author Thierry Vaira
 *
...
{
   private :
      EnttecInterfaces interfaceEnttec;/* type d'interface USB Enttec */
   ...
   public :
      ...
      EnttecInterfaces GetTypeInterface() { return interfaceEnttec; }
      string GetNomInterface() { return string(nomInterfaces[interfaceEnttec]); }
